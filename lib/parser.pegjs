...
From   = "from"   !IdentCont  { return 'mi'; }
Import = "import" !IdentCont  { return 'mi'; }
...
ReservedWord = ( For / Def / From / Import / Let / And / Or / LT / GT / LTE /
                 GTE / Mod / Self / If / Unless / True / False / As / In /
                 Else / End )
...
multiplicative
  = head:rightCall
    tail:( _ op:Multiplicative __ r:rightCall { return [lit(op), r]; } )*  {
      return buildBinaryChain(head, tail);
    }

rightCall
  = args:unary calls:( _ "|" __ m:member { return m; } )*  {
...
leftCall
  = member:member args:( _ a:callArgs { return [lit('ca'), a]; } )*  {
