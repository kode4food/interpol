  ...
  function processWarnings() {
    ...
    for ( var i = 0, len = warnings.length; i < len; i++ ) {
      var warning = warnings[i]
        ...
        , warningInfo = warning.err
        , lineInfo = ":" + warningInfo.line + ":" + warningInfo.column
        , warningString = warningInfo.message;

      console.warn((filePath || 'string') + lineInfo + ": " + warningString);
      console.warn("");
    }
  }
