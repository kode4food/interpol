...
function compile(parseOutput, localOptions) {
  ...
  // NOTE: If the right side is an array or dictionary, they are evaluated
  //       at run-time, even if their content is literal.  This means the
  //       match evaluator has no choice but to perform crude matching.
