...
ReservedWord = ( For / Def / From / Import / Export / Let / And / Or / Like /
                 ...
                 True / False / With / As / In / Else / End / When )
...
callArgs
  = "(" __ elems:elemList __ ")" withTail:withTail?  {
      if ( withTail ) {
        elems.push(withTail);
      }
      return elems;
    }
  / "(" __ ")" withTail:withTail?  {
...
withTail
  = _ With __ params:withParams? statements:statementsTail  {
      params = params || {};
