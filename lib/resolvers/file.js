 ...
 * 
 * @param options [Object] options Object for configuring the Resolver
 *   - path (str)- The base directory for resolving modules
 *   - monitor (bool)- Monitor files for changes (and take a performance hit)
 *   - compile (bool)- Parse raw templates (and take a performance hit)
 */
