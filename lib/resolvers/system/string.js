...
// Splits the provided string wherever the specified delimiter
// (or whitespace) is encountered and returns the result.
...
// Converts the provided string to title-case and returns the result.
// Title case converts the first character of each word to upper-case,
...
// Exports
exports.string = wrap(String);  // Convert value to a String
